...
const landingPageRoutes = (prefix) => [
    ...
    },
    {
        ...
        component: () => import('@/views/modules/landing-pages/BlogPage.vue')
    },
    {
        path: '/blog-details',
        name: prefix + 'blog-details',
        meta: { auth: true, name: 'Blogs', isBanner: true, header: 'header_one', footer: 'footer' },
        component: () => import('@/views/modules/landing-pages/BlogDetail.vue')
    },
    {
        path: '/contact-us',
        name: prefix + 'contact-us',
        meta: { auth: true, name: 'Contact Us', isBanner: true, header: 'header_one', footer: 'footer' },
        component: () => import('@/views/modules/landing-pages/ContactUs.vue')
    },
    {
        path: '/faq',
        name: prefix + 'faq',
        meta: { auth: true, name: 'FAQ', isBanner: true, header: 'header_one', footer: 'footer' },
        component: () => import('@/views/modules/landing-pages/FAQ.vue')
    },
    {
        path: '/features',
    ...
    },
    {
        ...
        component: () => import('@/views/modules/landing-pages/PricingPage.vue')
    },
    {
        path: '/software',
